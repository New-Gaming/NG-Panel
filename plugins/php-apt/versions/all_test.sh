...
# cd /www/server/ng-panel/plugins/php-apt/versions && /bin/bash all_test.sh


# cd /www/server/ng-panel && python3 /www/server/ng-panel/plugins/php-apt/index.py start 5.6


# cd /www/server/ng-panel
# cd /www/server/ng-panel/plugins/php-apt/versions && /bin/bash common.sh  5.6  install yaf
# cd /www/server/ng-panel/plugins/php-apt/versions && /bin/bash common.sh  7.1  install swoole
...
for PHP_VER in ${PHP_VER_LIST[@]}; do
	...
	if [ ! -d  /www/server/php-apt/${PHP_VER} ];then
		cd /www/server/ng-panel/plugins/php-apt && bash install.sh install ${PHP_VER}
	fi
