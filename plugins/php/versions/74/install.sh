...
cd $serverPath/ng-panel/plugins/php/lib && /bin/bash freetype_new.sh
cd $serverPath/ng-panel/plugins/php/lib && /bin/bash zlib.sh
cd $serverPath/ng-panel/plugins/php/lib && /bin/bash libzip.sh
